...
class ShapeCourse extends StatelessWidget {
  ...
  ShapeCourse({this.data,this.model});
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                      ...
                      dense: true,
                      trailing: Text(DateFormat('yyyy-MM-dd').format(data.courseEndIn), style: leadStyle)),
                  div,
                  ListTile(
                      leading: Text(translate('period'), style: leadStyle), dense: true, trailing: Text(data.period.toString(), style: leadStyle)),
                  div,
                  ListTile(
                      leading: Text(translate('days'), style: leadStyle), dense: true, trailing: Text(data.days.toString(), style: leadStyle)),
                  div,
                  ListTile(
                      leading: Text(translate('school'), style: leadStyle), dense: true, trailing: Text(data.schoolName, style: leadStyle)),
                  div,
                  ListTile(
                      leading: Text(translate('price'), style: leadStyle), dense: true, trailing: Text(data.price.toString(), style: leadStyle)),
                  div,
                  ListTile(leading: Text(translate('tax'), style: leadStyle), dense: true, trailing: Text(data.tax.toString(), style: leadStyle)),
                  div,
                  ListTile(
                      leading: Text(translate('total'), style: leadStyle), dense: true, trailing: Text((data.price + data.tax).toString(), style: leadStyle)),

                  model.isLoadPayment ? ShapeLoading3():TextButton(
                      onPressed: () => model.reserveCourse(context,data.id),
